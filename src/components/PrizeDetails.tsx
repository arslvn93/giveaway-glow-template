...
const PrizeDetails = ({
  ...
  return <section ref={sectionRef} className="py-16 md:py-24 relative overflow-hidden bg-gradient-to-b from-amber-50/50 to-amber-100/50" id="prizeDetails">
      ...
      <div className="container mx-auto px-4">
                      ...
                      <div className="p-1">
                        <div className="overflow-hidden rounded-xl shadow-md border border-amber-200">
                          <AspectRatio ratio={4 / 3} className="bg-muted">
                            <img src={image} alt={`Prize view ${index + 1}`} className="object-cover w-full h-full transition-all duration-700 hover:scale-110" />
                          </AspectRatio>
                        </div>
                      </div>
                    </CarouselItem>)}
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  ...
                  <ul className="space-y-3">
                    {features && features.length > 0 ? features.map((feature, index) => <li key={index} className="feature-item flex items-start hover:translate-x-1 transition-transform duration-300">
                        ...
                        </li>) : <li className="feature-item text-gray-500 italic">
        ...
        {/* Benefits Section */}
        {benefits && benefits.length > 0 && <div ref={benefitsRef} className="mt-20 md:mt-24">
            <div className="text-center mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {benefits.map((benefit, index) => <Card key={index} className="benefit-card border-amber-200 bg-white/80 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
